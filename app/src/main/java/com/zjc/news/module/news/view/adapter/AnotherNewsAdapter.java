...
import com.zjc.news.module.news.view.activity.NewsInfoActivity;
...
public class AnotherNewsAdapter extends RecyclerView.Adapter<AnotherNewsAdapter.ViewHolder> {

    private List<NewsBean.Result.Data> mNewsList;

    public AnotherNewsAdapter(List<NewsBean.Result.Data> mNewsList) {
